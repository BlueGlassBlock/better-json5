...
import { startClient, LanguageClientConstructor, SchemaRequestService, languageServerDescription, AsyncDisposable } from '../client';
...
export async function activate(context: ExtensionContext) {
	...
	const serverMain = `./${clientPackageJSON.main.indexOf('/dist/') !== -1 ? 'dist' : 'out'}/node/serverMain`;
